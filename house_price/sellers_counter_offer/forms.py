...
class SellersCounterOfferForm(forms.Form):
    ...
    sellers_spouse_name = forms.CharField(required=False, label="Seller's Spouse's Name")
    sellers_email = forms.CharField(required=False, label="Seller's Email")
    sellers_spouse_email = forms.CharField(required=False, label="Seller's Spouse's Email")
